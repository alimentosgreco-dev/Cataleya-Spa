...
import { TIME_SLOTS, isSlotAvailable } from "@/data/booking";
...
export function Booking() {
  const { form, errors, loading, confirmed, update, submit, reset } =
    useBookingForm();
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola, quiero agendar una cita en Cataleya Beauty & Spa.\nNombre: ${form.fullName}\nTratamiento: ${allTreatmentOptions.find((t) => t.value === form.treatmentId)?.label ?? ""}\nFecha: ${form.date}\nHora: ${form.time}`
  );

  if (confirmed) {
    return (
      <section id="reservar" className="relative py-20 md:py-28 overflow-hidden">
        <FloatingGradient className="top-0 left-1/4" />
        <div className="mx-auto max-w-lg px-4 text-center">
          ...
          >
            ...
            <p className="mt-3 text-gray-text">
              Gracias, {form.fullName}. Hemos registrado tu cita para el{" "}
              {form.date} a las {form.time}. Te enviaremos confirmación a{" "}
              {form.email}.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <SectionHeading
            ...
            subtitle="Selecciona fecha, horario y tratamiento. Experiencia premium en pocos pasos."
          />
        </Reveal>
            ...
            <Reveal className="lg:col-span-3" delay={0.2}>
              <GlassCard className="h-full">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <select
                      ...
                      aria-describedby={
                        errors.treatmentId ? "treatment-error" : undefined
                      }
                      required
                    >
                    ...
                    {errors.treatmentId && (
                      <p id="treatment-error" className="mt-1 text-sm text-red-500" role="alert">
                        {errors.treatmentId}
                      </p>
                    )}
                  </div>
                ...
                <p className="mt-4 text-xs text-gray-text text-center">
                  * Integración futura con API, Google Calendar y backend disponible
                </p>
              </GlassCard>
            </Reveal>
          </div>
